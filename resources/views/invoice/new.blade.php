            ...
            <form action="{{route('store-invoice')}}" method="post">
                @csrf
                    ...
                    <div class="form-group row {{ $errors->has('item')? 'has-error' : '' }}" >
                        ...
                        <div class="col-sm-3">
                            <input type="text" name="item_name[]" id="item_name" class="form-control" placeholder="Name - Ex: Rim of Wire" />
                            {!! e_form_error('item_name', $errors) !!}
                        </div>
                        <div class="col-sm-2">
                            <input type="number" name="item_price[]" id="item_price" class="form-control" placeholder="Price/Unit " />
                            {!! e_form_error('item_price', $errors) !!}
                        </div>
                        <div class="col-sm-2">
                            <input type="number" name="item_qty[]" id="item_qty" class="form-control" placeholder="Quantity" />
