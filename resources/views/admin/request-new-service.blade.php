        ...
        <div class="col-md-10">
            ...
            <form method="post" action="">
                ...
                <div class="alert alert-info">
                    ...
                    <div class="form-group row {{ $errors->has('is_premium')? 'has-error':'' }}">
                        ...
                        <div class="col-md-8">
                                ...
                                <a style="cursor: default;">Please select a category and sub-category that best describes the service you're reguesting.</a>
                        </div>
                    </div>
                </div>
                        ...
                        <select name="category" class="form-control {{e_form_invalid_class('category', $errors)}} state_options">
                            ...
                            @if($categories)
                                @foreach($categories as $category)
                                    <option value="{{ $category->category_slug}}" @if(old('category') && $category->category_slug == old('category')) selected="selected" @endif >{!! $category->category_name !!}</option>
                                @endforeach
                            @endif
                ...
                <div class="form-group row {{ $errors->has('sub_category')? 'has-error':'' }}">
                    <label for="category" class="col-sm-4 control-label">Sub Category: <span class="mendatory-mark">*</span></label>
                    <div class="col-sm-8">
                        <select class="form-control {{e_form_invalid_class('sub_category', $errors)}}" name="sub_category" id="category">
                            <option value="">Select a Sub Category</option>
                            
                                <option value=""></option>
                           
                        </select>
                        {!! e_form_error('sub_category', $errors) !!}
                    </div>
                </div>

                <div class="alert alert-info">

                    <legend><span class="fa fa-search-location"></span> Location Deatils</legend>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <select name="local_govt" class="form-control {{e_form_invalid_class('local_govt', $errors)}} state_options">
                ...
                <div class="form-group row {{ $errors->has('street_address')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control {{e_form_invalid_class('street_address', $errors)}}" id="city_name" value="{{ old('street_address') }}" name="street_address" placeholder="Ex: 27, Spring Road, Essien Town">
