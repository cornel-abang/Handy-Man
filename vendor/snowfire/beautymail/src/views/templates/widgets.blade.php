								...
								<td width="600" nowrap bgcolor="#f2f2f2" class="cell">
									...
									<table width="600" cellpadding="0" cellspacing="0" border="0" class="table">
										<tr>
											...
											<td align="left" width="220" style="color:#a6a6a6;font-size:12px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;text-shadow: 0 1px 0 #ffffff;" valign="top" class="hide">
